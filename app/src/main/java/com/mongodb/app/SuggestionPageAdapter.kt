...
class SuggestionPageAdapter(private var tourneyQuery: RealmResults<Tournament>, private var images: IntArray): RecyclerView.Adapter<SuggestionPageAdapter.ViewHolder>() {
