...
class TournamentInAdapter(private var tourneyQuery: RealmList<Tournament>, private var images: IntArray): RecyclerView.Adapter<TournamentInAdapter.ViewHolder>() {
